...
$lang = array_merge($lang, [
	...
	'ACP_POINTS_BOUNTY_TITLE' => 'Bounty board',
	'ACP_POINTS_BOUNTY_EXPLAIN' => 'Here you can alter the settings of the Bounty board module.',
	'ACP_POINTS_DUELS_EXPLAIN' => 'Here you can alter the settings of the Duel/Wager module.',
	...
	'BOUNTY_ENABLE' => 'Enable bounty board',
	'BOUNTY_ENABLE_EXPLAIN' => 'This will allow users to post and claim bounties.',
	'BOUNTY_MIN_REWARD' => 'Minimum reward',
	'BOUNTY_MIN_REWARD_EXPLAIN' => 'The lowest reward a member may offer for a bounty.',
	'BOUNTY_MAX_REWARD' => 'Maximum reward',
	'BOUNTY_MAX_REWARD_EXPLAIN' => 'The highest reward a member may offer for a bounty.',
	'BOUNTY_MIN_MAX_ERROR' => 'The minimum reward cannot be higher than the maximum reward!',
	'BOUNTY_CLAIM_TIME_LIMIT' => 'Claim time limit',
	'BOUNTY_CLAIM_TIME_LIMIT_EXPLAIN' => 'Hours a claim may sit unsubmitted before it is automatically released back to the open pool. Set to 0 to disable this feature.',
	'BOUNTY_REQUIRE_APPROVAL' => 'Require poster approval',
	'BOUNTY_REQUIRE_APPROVAL_EXPLAIN' => 'If enabled, the reward only pays out after the poster approves the claimer’s submission. If disabled, submitting the work pays out immediately.',
	'BOUNTY_MCHAT_OPTIONS' => 'Bounty mChat Settings',
	'BOUNTY_MCHAT_ENABLE' => 'Enable posting in mChat for the bounty board',
	'BOUNTY_MCHAT_ENABLE_EXPLAIN' => 'Post new bounties, claims and payouts in mChat.',
	'BOUNTY_OPTIONS' => 'Bounty Board Settings',

	'DUEL_ENABLE' => 'Enable duel/wager module',
	'DUEL_ENABLE_EXPLAIN' => 'This will allow users to challenge each other to a wager.',
	'DUEL_MIN_WAGER' => 'Minimum wager',
	'DUEL_MIN_WAGER_EXPLAIN' => 'The lowest wager a member may stake on a duel.',
	'DUEL_MAX_WAGER' => 'Maximum wager',
	'DUEL_MAX_WAGER_EXPLAIN' => 'The highest wager a member may stake on a duel.',
	'DUEL_MIN_MAX_ERROR' => 'The minimum wager cannot be higher than the maximum wager!',
	'DUEL_ACCEPT_TIME_LIMIT' => 'Accept time limit',
	'DUEL_ACCEPT_TIME_LIMIT_EXPLAIN' => 'Hours a challenge may sit unaccepted before it is automatically cancelled and refunded to the challenger. Set to 0 to disable this feature.',
	'DUEL_MAX_OPEN_PER_USER' => 'Max. open challenges per user',
	'DUEL_MAX_OPEN_PER_USER_EXPLAIN' => 'How many pending challenges a single member may have outstanding at once. Set to 0 to disable this limit.',
	'DUEL_DEFAULT_ADMIN_RESOLVE' => 'Default resolution type',
	'DUEL_DEFAULT_ADMIN_RESOLVE_EXPLAIN' => 'Pre-selects moderator-decided as the default option on the challenge form. Members can still choose coin-flip instead.',
	'DUEL_MCHAT_OPTIONS' => 'Duel mChat Settings',
	'DUEL_MCHAT_ENABLE' => 'Enable posting in mChat for duels',
	'DUEL_MCHAT_ENABLE_EXPLAIN' => 'Post new challenges and duel results in mChat.',
	'DUEL_OPTIONS' => 'Duel/Wager Settings',
	...
	'LOG_MOD_POINTS_BOUNTY' => 'Updated the Ultimate Points bounty board settings',
	'LOG_MOD_POINTS_DUELS' => 'Updated the Ultimate Points duel/wager settings',
