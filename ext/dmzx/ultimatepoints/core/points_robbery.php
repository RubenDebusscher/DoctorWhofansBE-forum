...
class points_robbery
{
	...
	function main($checked_user)
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			{
				$message = $this->language->lang('ROBBERY_TOO_SMALL_AMOUNT') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
				trigger_error($message);
			}
			...
			if (empty($username))
			{
				$message = $this->language->lang('ROBBERY_NO_ID_SPECIFIED') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
				trigger_error($message);
			}
			...
			{
				$message = $this->language->lang('ROBBERY_SELF') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
				trigger_error($message);
			}
			...
			if ($points_values['robbery_loose'] != 0)
			{
				...
				{
					$message = $this->language->lang('ROBBERY_TO_MUCH') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
					trigger_error($message);
				}
			}
			...
			if (!$user_id)
			{
				$message = $this->language->lang('POINTS_NO_USER') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
				trigger_error($message);
			}
			...
			{
				$message = $this->language->lang('ROBBERY_TO_MUCH_FROM_USER') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
				trigger_error($message);
			}
			...
			if ($points_values['robbery_max_rob'] != 0)
			{
				...
				{
					$message = sprintf($this->language->lang('ROBBERY_MAX_ROB'), $points_values['robbery_max_rob']) . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
					trigger_error($message);
				}
			}
			...
			if ($rand_value <= $rand_base)
			{
				...
				$message = $this->language->lang('ROBBERY_SUCCESFUL') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
				trigger_error($message);
			...
			else
			{
				if ($points_values['robbery_loose'] != 0)
				{
					...
					$message = $this->language->lang('ROBBERY_BAD') . '<br /><br /><a href="' . $this->helper->route('dmzx_ultimatepoints_controller', ['mode' => 'robbery']) . '">&laquo; ' . $this->language->lang('BACK_TO_PREV') . '</a>';
					trigger_error($message);
				}
			}
