...
$lang = array_merge($lang, array(
	...
	'LAST_TYPE'				            => 'Template',
    'LAST_TYPE_EXPLAIN'                 => 'Choose the template to display - the current options are Forabg <strong>(Visible on Mobile)</strong> and Forabg 2 <strong>(Visible only on PC)</strong>',
