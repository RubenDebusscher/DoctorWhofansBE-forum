...
motUsermap.addPoiLayer = function(myLayerGroup, myIconPath, lat, lng, myName, myPopup, myIconSize, myIconAnchor) {
	myIconAnchor = myIconAnchor.split(',');
	myIconSize = myIconSize.split(',');

	var iconOptions = {
		iconUrl:	myIconPath,
		iconAnchor:	[Number(myIconAnchor[0]), Number(myIconAnchor[1])],
		iconSize:	[Number(myIconSize[0]), Number(myIconSize[1])],
	}
